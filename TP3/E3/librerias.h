...
#define ERROR_KEY       4
#define ERROR_CANT_PARAMETROS    5
...
int actualiza_pago(t_socio arraySocios[CANT_MAX_SOCIOS], long dni, t_fecha fecha, int anioActual, int mesActual){
    if (anioActual == fecha.anio && mesActual == fecha.mes) {
