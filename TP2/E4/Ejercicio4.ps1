...
Ejemplo de ejecucion:> ./Ejercicio4.sh  -Directorio <path_directorio_Log> -DirectorioZip <path_directorio_Zip>
Ejemplo de ejecucion:> ./Ejercicio4.sh  -Directorio <path_directorio_Log> -DirectorioZip <path_directorio_Zip> -Empresa <empresa>
